...
<output_schema>
Your entire response MUST be a single JSON object that validates against this JSON Schema.
Do not wrap it in Markdown code fences and do not add any prose before or after it.
{{OUTPUT_SCHEMA}}
</output_schema>
