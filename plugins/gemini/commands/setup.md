...
- If Gemini is installed but not authenticated, preserve the authentication guidance from the setup output (run `!gemini` once to pick a sign-in method, or set `GEMINI_API_KEY` / `GOOGLE_API_KEY`).
