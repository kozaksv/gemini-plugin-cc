...
description: Internal guidance for composing Gemini and Gemini prompts for coding, review, diagnosis, and research tasks inside the Gemini Claude Code plugin
